...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        body {
            background-color: rgb(115, 215, 228);
        }
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="px-5 m-3">
            <div class="row justify-content-center shadow bg-white rounded">
                <div>
                ...
                <div class="pt-1 form-check text-start">
                    <label for="gender" class="fs-6 form-label text-start">Gender:</label>
                    <asp:RadioButton GroupName="GenderRadioGroup" Text="Male" ID="male" value = "Male" runat="server" />
                    
                    <asp:RadioButton GroupName="GenderRadioGroup" Text="Female" ID="female" value = "Female" runat="server" />
